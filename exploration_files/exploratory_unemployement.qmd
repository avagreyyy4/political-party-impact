...
ag_pct_all <- map_dfr(years, function(year) {
  df <- get_acs(
    geography = "state",
    table = "C24050",
    survey = "acs1",
...
write_csv(ag_pct_obama, "data/ag_pct_obama.csv")
```
...
state_choropleth(
  ...
  scale_fill_gradient2(low = "darkorange", mid = "white", high = "darkgreen", na.value = "white")
